...
`main` 브랜치는 EasyNote의 원본 소스 코드를 공개하는 곳입니다. 개인 개발자, 학습자, EasyNote를 자신이 원하는 버전으로 계속 만들어 가려는 사람에게 적합합니다.

이 브랜치는 소스 코드 출발점이며, 권장되는 일상 사용 다운로드 버전은 아닙니다. 프로젝트가 업데이트되면서 완성되지 않았거나 불안정한 내용이 포함될 수 있습니다.
